...
* [API Docs](https://aws.github.io/aws_iot_device_sdk_python_v2/)
...
git clone -b <SDK_VERSION> https://github.com/aws/aws_iot_device_sdk_python_v2.git
...
#    local build in "aws_iot_device_sdk_python_v2/awsiot/__init__.py"
sed -i "s/__version__ = '1.0.0-dev'/__version__ = '<SDK_VERSION>'/" \
  aws_iot_device_sdk_python_v2/awsiot/__init__.py
...
* Check for similar [Issues](https://github.com/aws/aws_iot_device_sdk_python_v2/issues)
